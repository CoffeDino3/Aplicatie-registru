...
public class Optiuni {
    ...
    public Optiuni(App app){
        ...
        btn1.setOnMouseEntered(e ->btnRect1.setFill(javafx.scene.paint.Color.web("#7a1f1f")));
        btn1.setOnMouseExited(e-> btnRect1.setFill(javafx.scene.paint.Color.web("#a04e41")));
        ...
        btn2.setCursor(javafx.scene.Cursor.HAND);
        btn2.setOnMouseEntered(e->btnRect2.setFill(javafx.scene.paint.Color.web("#7a1f1f")));
        btn2.setOnMouseExited(e -> btnRect2.setFill(javafx.scene.paint.Color.web("#a04e41")));
        ...
        btn3.setCursor(javafx.scene.Cursor.HAND);
        btn3.setOnMouseEntered(e -> btnRect3.setFill(javafx.scene.paint.Color.web("#7a1f1f")));
        btn3.setOnMouseExited(e ->btnRect3.setFill(javafx.scene.paint.Color.web("#a04e41")));
        ...
        btn.setOnMouseEntered(e ->btnView.setOpacity(0.7));
