...
public class AdaugStudenti {
    ...
    public AdaugStudenti(App app) {
        ...
        addRect.setArcWidth(10); addRect.setArcHeight(10);
        ...
        xRect.setArcWidth(8); xRect.setArcHeight(8);
        ...
        fNume.setStyle("-fx-background-color: #c97a60; -fx-background-radius: 10; -fx-font-size: 13px;");

        TextField fPrenume=new TextField();
        fPrenume.prefWidthProperty().bind(root.widthProperty().multiply(0.25));
        fPrenume.setStyle("-fx-background-color: #c97a60; -fx-background-radius: 10; -fx-font-size: 13px;");

        ComboBox<String> cbGrupa=new ComboBox<>();
        cbGrupa.prefWidthProperty().bind(root.widthProperty().multiply(0.25));
        cbGrupa.setStyle("-fx-background-color: #c97a60; -fx-background-radius: 10; -fx-font-size: 13px;");
        try {
        ...
        btnRect2.setArcWidth(15); btnRect2.setArcHeight(15);
