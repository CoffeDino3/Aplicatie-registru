...
public class ModNote {
    ...
    public ModNote(App app) {
        ...
        HBox headerRow= new HBox(0, creeazaHeaderCelula("ID", 0.10, root), creeazaHeaderCelula("Student", 0.25, root), creeazaHeaderCelula("Nota", 0.13, root), creeazaHeaderCelula("Disciplina", 0.31, root));
        ...
        HBox dataRow =new HBox(0, new StackPane(cbId), creeazaDataCelula(tStudent, 0.25, root), creeazaDataCelula(tNota, 0.13, root), creeazaDataCelula(tDisc, 0.31, root));
        dataRow.setAlignment(Pos.CENTER);

        final int[] noteIdSelectat= {-1};
        final Note[] notaSelectata =new Note[1];
        ...
        HBox checkRow =new HBox(50, creeazaCheckLabel("Nota", ckNota, root), creeazaCheckLabel("Disciplina", ckDisc, root));
        ...
        for (int i= 1; i <=10; i++) cbNotaField.getItems().add(i);
        ...
        for (Discipline d : Discipline.values()) cbDiscField.getItems().add(d.getDenumire());
        ...
        btnConfirm.setOnMouseClicked(e -> {
            ...
            try {
                if (ckNota.isSelected()&& cbNotaField.getValue() != null) {
                    ...
                    tNota.setText(String.valueOf(cbNotaField.getValue()));
                }
