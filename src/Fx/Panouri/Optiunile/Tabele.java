...
public class Tabele {
    ...
    public Tabele(App app) {
        ...
        Text text =new Text( "SELECTEAZA TABELUL");
        text.setFill(javafx.scene.paint.Color.web("#000000"));
        text.styleProperty().bind(root.widthProperty().divide( 14).asString(
        ...
        javafx.application.Platform.runLater(() -> {
            text.setLayoutX((textLayer.getWidth()- text.getBoundsInLocal().getWidth()) / 2);
            text.setLayoutY(textLayer.getHeight() * 0.40);
        });
        ...
        btn1.styleProperty().bind(root.widthProperty().divide( 28).asString("-fx-font-size: %.0fpx; -fx-font-weight: bold;"));
        ...
        btn2.styleProperty().bind(root.widthProperty().divide(28).asString("-fx-font-size: %.0fpx; -fx-font-weight: bold;"));
        ...
        btn3.styleProperty().bind(root.widthProperty().divide(28).asString("-fx-font-size: %.0fpx; -fx-font-weight: bold;"));
        ...
        root.heightProperty().addListener((obs,oldVal, newVal)-> {
            javafx.application.Platform.runLater(() -> {
                btn1.setLayoutY(textLayer.getHeight() *0.60);
                btn2.setLayoutY(textLayer.getHeight() * 0.40);
                btn3.setLayoutY(textLayer.getHeight() *0.60);
            });
        });
        javafx.application.Platform.runLater(()->  {
        ...
        btn1.setOnMouseClicked(e-> app.arataAlegStud());
        btn2.setOnMouseClicked(e -> app.arataAlegGrupe());
        btn3.setOnMouseClicked(e -> app.arataAlegNote());
