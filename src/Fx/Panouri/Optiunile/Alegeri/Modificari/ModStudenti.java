...
public class ModStudenti {
    ...
    public ModStudenti(App app) {
        ...
        HBox headerRow=new HBox(0,
                ...
                creeazaHeaderCelula("Nume",0.18,root),
                creeazaHeaderCelula("Prenume",0.18,root),
                creeazaHeaderCelula("Grupa",0.13,root),
                creeazaHeaderCelula("Poza",0.20,root)
        );
        ...
        Runnable refreshIds=() -> {
            ...
            try {
                ...
                {
                    cbId.getItems().add(String.valueOf(s.getId()));
                }
        ...
        HBox dataRow=new HBox(0,new StackPane(cbId),creeazaDataCelula(tNume,0.18,root),
                creeazaDataCelula(tPrenume,0.18,root),creeazaDataCelula(tGrupa,0.13,root),celulaPoza);
                ...
                if(studentSelectat[0]!=null)
                {
                    ...
                    if(poza!=null&&!poza.isEmpty())
                    {
                        try {
                            ...
                            if(poza.startsWith("/"))
                            {
                                img=new Image(App.class.getResourceAsStream(poza));
                            }
                            else
                            {
                                img=new Image(new File(poza).toURI().toString());
                            }
        ...
        HBox checkRow=new HBox(50,creeazaCheckLabel("Nume",ckNume,root),creeazaCheckLabel("Prenume",ckPrenume,root),
                creeazaCheckLabel("Grupa",ckGrupa,root),creeazaCheckLabel("Poza",ckPoza,root));
        ...
        try {
            ...
            {
                cbGrupaField.getItems().add(g.getGrupa());
            }
        } catch (SQLException ex) {
        }
        ...
        plusText.styleProperty().bind(root.widthProperty().divide(10).asString(
                "-fx-font-size: %.0fpx; -fx-font-weight: bold;"));
